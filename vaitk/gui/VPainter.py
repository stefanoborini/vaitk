...
class VPainter:
    ...
    def drawText(self, pos_or_rect, string, align=0):
        ...
        if align & (Alignment.AlignTop | Alignment.AlignVCenter |
                    Alignment.AlignBottom) == 0:
            align |= Alignment.AlignTop

        if align & (Alignment.AlignLeft | Alignment.AlignHCenter |
                    Alignment.AlignRight) == 0:
        ...
        for h in range(rect[Index.RECT_HEIGHT]):
            if (align & Alignment.AlignTop and h == 0) or \
               (align & Alignment.AlignVCenter and
                h == int(rect[Index.RECT_HEIGHT]/2)) or \
    ...
    def drawRect(self, rect):
        ...
        top_left_corner = self._graphic_elements[
            "BOX DRAWINGS LIGHT DOWN AND RIGHT"]
        top_border = self._graphic_elements[
            "BOX DRAWINGS LIGHT HORIZONTAL"]
        top_right_corner = self._graphic_elements[
            "BOX DRAWINGS LIGHT DOWN AND LEFT"]
        right_border = self._graphic_elements[
            "BOX DRAWINGS LIGHT VERTICAL"]
        bottom_right_corner = self._graphic_elements[
            "BOX DRAWINGS LIGHT UP AND LEFT"]
        bottom_border = self._graphic_elements[
            "BOX DRAWINGS LIGHT HORIZONTAL"]
        bottom_left_corner = self._graphic_elements[
            "BOX DRAWINGS LIGHT UP AND RIGHT"]
        left_border = self._graphic_elements[
            "BOX DRAWINGS LIGHT VERTICAL"]
    ...
    def drawLine(self, pos, length, direction):
        ...
        or vertical.
        The line is always drawn left to right (Horizontal) or top to bottom
        (Vertical)
    ...
    def eraseRect(self, rect):
        ...
        for h_idx in range(rect[Index.RECT_HEIGHT]):
            screen_area.write((top_left[Index.X], top_left[Index.Y] + h_idx),
                              string,
                              widget_colors[Index.FG_COLOR],
                              widget_colors[Index.BG_COLOR])
